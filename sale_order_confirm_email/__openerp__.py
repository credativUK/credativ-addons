...
{'name': 'Automatic email triggered for confirmed sales orders',
 'version': '1.0.0',
 'category': 'Sales',
 'author': 'credativ Ltd',
 ...
 'license': 'AGPL-3',
 'description': """
Automatically sends an email when a sales order is confirmed for a customer who is not set as opt-out.
...
* Server action: "Email confirmed sales order"
""",
 'depends': [
     'sale',
     'email_template',
