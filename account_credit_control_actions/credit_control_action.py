...
##############################################################################
#
#    Author: Nicolas Bessi, Guewen Baconnier, Craig Gowing
...
class CreditControlEmailer(osv.osv_memory):
    """Run server actions for each selected credit control lines."""

    _name = "credit.control.action"
    _description = """Mass credit line actions"""
    _rec_name = 'id'
    ...
    _columns = {
        'line_ids': fields.many2many(
            ...
            domain="[('state', '=', 'to_be_sent'), ('channel', '=', 'action')]"),
    }
    ...
    def action_lines(self, cr, uid, wiz_id, context=None):
        ...
        comm_obj._generate_actions(cr, uid, comms, context=context)
        return {}
